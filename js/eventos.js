const WPP_NUMBER = "55XXXXXXXXXXX";
const SALES_EMAIL = "contato@seudominio.com.br";
...
const ADICIONAIS = [
  ...
  { canon: "mandioca_frita", label: "Mandioca frita", categoria: "Entradas", tipo: "per_person", valor: 8.00, img: "mandioca.jpg" },
  { canon: "croquete_cupim", label: "Croquete de cupim", categoria: "Entradas", tipo: "per_person", valor: 8.00, img: "croquetecupim.jpeg" },
  { canon: "queijo_coalho_mel", label: "Queijo coalho com mel", categoria: "Entradas", tipo: "per_person", valor: 15.00, img: "queijocoalho.jpg" },
  { canon: "matambrito", label: "Matambrito de porco", categoria: "Entradas", tipo: "per_person", valor: 15.00, img: "matambrito.jpg" },
  { canon: "batata_frita", label: "Batata frita", categoria: "Entradas", tipo: "per_person", valor: 8.00, img: "batata.jpg" },

  { canon: "bife_ancho_black_rub", label: "Bife Ancho com Black Rub", categoria: "Cortes Especiais", tipo: "per_person", valor: 35.00, img: "bifeancho.jpg" },
  { canon: "picanha_la_majestad", label: "Picanha", categoria: "Cortes Especiais", tipo: "per_person", valor: 45.00, img: "picanha.jpg" },
  { canon: "french_rack_cordeiro", label: "T-bone de cordeiro", categoria: "Cortes Especiais", tipo: "per_person", valor: 55.00, img: "frenchrack.jpg" },
  { canon: "corte_wagyu", label: "Corte Wagyu", categoria: "Cortes Especiais", tipo: "per_person", valor: 75.00, img: "wagyu.jpeg" },

  { canon: "arroz_biro_biro", label: "Arroz biro biro", categoria: "Acompanhamentos", tipo: "per_person", valor: 15.00, img: "arrozbirobiro.jpeg" },
  { canon: "arroz_caldoso_costela", label: "Arroz caldoso de costela", categoria: "Acompanhamentos", tipo: "per_person", valor: 15.00, img: "arrozcaldoso.jpg" },
  { canon: "salada_caesar", label: "Salada Caesar", categoria: "Acompanhamentos", tipo: "per_person", valor: 10.00, img: "saladacaesar.jpeg" },
  { canon: "mandioca_cremosa", label: "Mandioca cremosa", categoria: "Acompanhamentos", tipo: "per_person", valor: 8.00, img: "mandiocacremosa.jpg" },
  { canon: "legumes_grelhados", label: "Legumes grelhados", categoria: "Acompanhamentos", tipo: "per_person", valor: 8.00, img: "legumesgrelhados.jpeg" },

  { canon: "panqueca_doce_leite", label: "Panqueca de doce de leite", categoria: "Sobremesa", tipo: "per_person", valor: 9.00, img: "panquecadoceleite.jpg" },
...
function loadTerms() {
  ...
  fetch("termos-evento.html", { cache: "no-store" })
    .then(r => r.text())
    .then(html => {
...
/* Expor init e inicializar no DOMContentLoaded */
window.EventosInit = EventosInit;
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", () => {
    if (document.getElementById("menuGrid")) EventosInit();
  }, { once: true });
} else {
  if (document.getElementById("menuGrid")) EventosInit();
}
